...
export function IPv6Input({ highlightedCell, onHighlight }: IPv6InputProps) {
  ...
  return (
    ...
    >
      <InputPart
        value={p1}
        onChange={(value) => dispatch({ kind: "SetIPv6", ipv6: [value, p2, p3, p4, p5, p6, p7, p8, prefixLength] })}
        max={65535}
        shiftStep={256}
      ...
      <InputPart
        value={p2}
        onChange={(value) => dispatch({ kind: "SetIPv6", ipv6: [p1, value, p3, p4, p5, p6, p7, p8, prefixLength] })}
        max={65535}
        shiftStep={256}
      ...
      <InputPart
        value={p3}
        onChange={(value) => dispatch({ kind: "SetIPv6", ipv6: [p1, p2, value, p4, p5, p6, p7, p8, prefixLength] })}
        max={65535}
        shiftStep={256}
      ...
      <InputPart
        value={p4}
        onChange={(value) => dispatch({ kind: "SetIPv6", ipv6: [p1, p2, p3, value, p5, p6, p7, p8, prefixLength] })}
        max={65535}
        shiftStep={256}
      ...
      <InputPart
        value={p5}
        onChange={(value) => dispatch({ kind: "SetIPv6", ipv6: [p1, p2, p3, p4, value, p6, p7, p8, prefixLength] })}
        max={65535}
        shiftStep={256}
      ...
      <InputPart
        value={p6}
        onChange={(value) => dispatch({ kind: "SetIPv6", ipv6: [p1, p2, p3, p4, p5, value, p7, p8, prefixLength] })}
        max={65535}
        shiftStep={256}
      ...
      <InputPart
        value={p7}
        onChange={(value) => dispatch({ kind: "SetIPv6", ipv6: [p1, p2, p3, p4, p5, p6, value, p8, prefixLength] })}
        max={65535}
        shiftStep={256}
      ...
      <InputPart
        value={p8}
        onChange={(value) => dispatch({ kind: "SetIPv6", ipv6: [p1, p2, p3, p4, p5, p6, p7, value, prefixLength] })}
        max={65535}
        shiftStep={256}
      ...
      <InputPart
        value={prefixLength}
        onChange={(value) => dispatch({ kind: "SetIPv6", ipv6: [p1, p2, p3, p4, p5, p6, p7, p8, value] })}
        max={128}
        shiftStep={8}
        isHexadecimal={false}
